class MIconParticlesView extends MDisplayObject
{
	...
	update(aFramesCount_int)
	{
		...
		this._fTargetY_num -= MIconParticlesView.MOVE_SPEED * aFramesCount_int;

		switch(this._fStateId_int)
		{
			case MFireView.STATE_ID_INTRO:
			{
				this._fTargetAlpha_num += MIconParticlesView.INTRO_ALPHA_SPEED * aFramesCount_int;
				this._fTargetScale_num += MIconParticlesView.INTRO_SCALE_SPEED * aFramesCount_int;
			...
			{
				this._fTargetAlpha_num -= MIconParticlesView.OUTRO_ALPHA_SPEED * aFramesCount_int;
				this._fTargetScale_num -= MIconParticlesView.OUTRO_SCALE_SPEED * aFramesCount_int;
