class MForegroundChipView extends MBaseCoinView
{
	...
	update(aFramesCount_num)
	{
		...
		this._fTargetRotation_num += MForegroundChipView.ROTATION_SPEED * aFramesCount_num;
		this._fTargetFlip_num += MForegroundChipView.FLIP_SPEED * aFramesCount_num;
		this._fShiftAngle_num += MForegroundChipView.SHIFT_ANGLE_CHANGE_SPEED * aFramesCount_num;
		this.setXY(
			this.getX() + MForegroundChipView.SHIFT_SPEED * Math.cos(this._fShiftAngle_num) * aFramesCount_num,
			this.getY() + MForegroundChipView.FALL_SPEED * this._fTargetScale_num * aFramesCount_num);
